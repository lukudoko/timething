...
//const [newPosition, setNewPosition] = useState(''); // Default position	
	
	
	const [newPosition, setNewPosition] = useState('-6666'); // Default position
 ...
 const generateBackgroundGradient = (sunData) => {
    ...
    return (
<div className="fixed h-[900vh] w-screen top-0" style={{ 
    background: gradientString, 
    backgroundPositionY: `${newPosition}px`,
